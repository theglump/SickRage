...
class EZRSSProvider(generic.TorrentProvider):
    ...
    def _doSearch(self, search_params, search_mode='eponly', epcount=0, age=0):
        ...
        search_url = 'http://192.168.1.39:8080/betarss/feed/show?provider=eztv&magnet=true&' + urllib.urlencode(params)
...
class EZRSSCache(tvcache.TVCache):
    ...
    def _getRSSData(self):
        rss_url = self.provider.url + 'http://192.168.1.39:8080/betarss/feed/latest?provider=eztv&magnet=true&mode=rss'
